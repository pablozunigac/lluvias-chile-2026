...
* **Afectación Territorial (Coquimbo a Ñuble, excepto RM):**  
...
* **Intensidad y Concentración de la Lluvia:**  
El sistema presentó acumulados extremos y focos de alta concentración en cortos periodos. En la franja entre Coquimbo y Ñuble se registraron montos generales de **200 a 350 mm**, con máximos históricos en zonas precordilleranas y costeras, acompañados de rachas de viento destructivas y oleaje extremo con olas de hasta 5 metros.
* **Frentes Consecutivos y Duración:**  
El fenómeno meteorológico operó bajo una dinámica ininterrumpida de **frentes de mal tiempo encadenados ("_tren de sistemas frontales_")** desde el 14 de julio en adelante, perpetuando pulsos de precipitaciones sucesivos que impidieron el drenaje y mantuvieron los suelos en un estado crítico de saturación hídrica.
* **Récords Históricos de Precipitación:**  
Las intensas lluvias marcaron hitos sin precedentes ubicándose en el *top 5* histórico para un mes de julio desde que existen registros instrumentales:
  * **La Serena (Estación La Florida):** Acumuló **200,.2 mm**, el mayor registro para un mes de julio desde 1954.
  * **Combarbalá (Est. Samuel Román Rojas):** Alcanzó **285.5 mm**, batiendo el récord absoluto de su historial de mediciones.
  * **Valparaíso (Est. Rodelillo / Faro Punta Ángeles):** Registró **173.6 mm** en solo 48 horas, cerrando el mes con acumulados históricos de hasta **327.3 mm**.
  * **Chillán:** Consolidó **312.2 mm** acumulados durante el mes de julio.
